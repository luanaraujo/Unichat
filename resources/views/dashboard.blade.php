...
<x-app-layout title="Chat">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" >
            <div class="bg-teal-40 overflow-hidden shadow-xl sm:rounded-lg flex " style="min-height: 450px; max-height: 500px;">

                <!--Lista de Usuários-->
                    
            <div class="w-3/12 max-h-450px bg-gradient-to-b from-sky-600 to-sky-800 bg-opacity-25 border-r border-sky-600 overflow-y-scroll" >
                <ul>
